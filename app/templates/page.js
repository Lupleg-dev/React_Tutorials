          ...
          <div className="container px-4 md:px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-8">
              <Card>
                ...
                <CardContent>
                  <p className="text-gray-500">
                    Lupleg has transformed my learning experience. The
                    personalized approach really works for me.
                  </p>
                </CardContent>
              </Card>
              <Card>
                ...
                <CardContent>
                  <p className="text-gray-500">
                    As a teacher, I appreciate the data-driven insights. It
                    helps me understand each students needs.
                  </p>
                </CardContent>
              </Card>
              <Card>
                ...
                <CardContent>
                  <p className="text-gray-500">
                    My child loves the interactive content. Learning has become
