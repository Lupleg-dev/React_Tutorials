    ...
    <main className="container mx-auto py-12 px-4 sm:px-6 lg:px-8">
      <section className="mb-8">
        ...
        <p className="mt-2 text-gray-600">
          We offer a wide range of courses to help you master the skills you need to advance your career. Explore our
          courses below.
        </p>
      </section>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <Card className="bg-white shadow-xl rounded-lg overflow-hidden">
          ...
          <CardContent className="p-4">
            <p className="mb-4">
              An introductory course to understand the basics of Artificial Intelligence. No previous experience
              required.
            </p>
        ...
        <Card className="bg-white shadow-xl rounded-lg overflow-hidden">
          ...
          <CardContent className="p-4">
            <p className="mb-4">
              This course dives deep into Machine Learning algorithms and techniques. Prior knowledge of ML is
              necessary.
            </p>
            <h3 className="font-semibold text-lg">Topics:</h3>
            <ul className="list-disc list-inside text-sm">
        ...
        <Card className="bg-white shadow-xl rounded-lg overflow-hidden">
          ...
          <CardContent className="p-4">
            <p className="mb-4">
              Utilize Python for data analysis and visualization. Basic Python knowledge is recommended.
            </p>
            <h3 className="font-semibold text-lg">Topics:</h3>
            <ul className="list-disc list-inside text-sm">
              <li>Pandas</li>
        ...
        <Card className="bg-white shadow-xl rounded-lg overflow-hidden">
          ...
          <CardContent className="p-4">
            <p className="mb-4">
              Learn to build dynamic web applications using React. Basic JavaScript knowledge is required.
            </p>
            <h3 className="font-semibold text-lg">Topics:</h3>
            <ul className="list-disc list-inside text-sm">
              <li>JSX</li>
        ...
        <div className="space-y-6">
          <Card className="bg-white shadow-xl rounded-lg overflow-hidden">
            <CardHeader className="bg-gray-100 p-4 border-b border-gray-200">
              <h3 className="text-xl font-semibold">How does the learning process work?</h3>
            </CardHeader>
            <CardContent className="p-4">
              <p>
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed euismod elit in mi consectetur, sit amet
                ornare purus pulvinar.
              </p>
            </CardContent>
          </Card>
          <Card className="bg-white shadow-xl rounded-lg overflow-hidden">
          ...
          <Card className="bg-white shadow-xl rounded-lg overflow-hidden">
            <CardHeader className="bg-gray-100 p-4 border-b border-gray-200">
              <h3 className="text-xl font-semibold">Can I switch my course midway?</h3>
            </CardHeader>
            <CardContent className="p-4">
              <p>
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed euismod elit in mi consectetur, sit amet
